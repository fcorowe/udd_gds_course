...
In this section we will learn the intuition of how we can represent spatial relationships in practice. 
...
A approach is to define weights based on the distances between a reference observation and a the set of *k* observations; that is, the closest. For more details see [this vignette](https://r-spatial.github.io/spdep/reference/knearneigh.html)
...
> Note: 'zero.policy = TRUE' allows listing non-neighbours. See what happens if you drop this argument or print `rswm_queen'. 
